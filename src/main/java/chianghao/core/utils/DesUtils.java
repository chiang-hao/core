...
public class DesUtils{
	...
	private final static String defaultKey = "ABCDEFGH";
	...
	public static String encrypt(String data) throws Exception {
		...
		String strs = Base64.getEncoder().encodeToString(bt);//.encode(bt);
		return strs;
	}
	...
	public static String decrypt(String data) throws IOException, Exception {
		...
		byte[] buf = Base64.getDecoder().decode(data);//decoder.decodeBuffer(data);
